...
image: /img/blog-images/old-post/2017/10/foto33.jpg
categories:
- automation
- cucumber
- qa
...
![resources](/img/blog-images/old-post/2017/10/resources.png)

De nuevo creamos un constructor privado y un Singleton pattern para crear una instancia única de la clase:

![constructor.png](/img/blog-images/old-post/2017/10/constructor1.png)

Y ahora vamos al método más importante de esta clase: createNewWebDriver().

![createnewwebdriver.png](/img/blog-images/old-post/2017/10/createnewwebdriver.png)
...
![drivers](/img/blog-images/old-post/2017/10/drivers.png)
...
_**getSelectorFromProperties():**_![getselector](/img/blog-images/old-post/2017/10/getselector.png)
...
**_getCompleteElement()_**![get.png](/img/blog-images/old-post/2017/10/get.png)
